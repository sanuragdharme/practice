...
IFontDisp = Font
__all__ = [ 'FONTNAME', 'StdPicture', 'VgaColor', 'Color', 'Picture',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_YPOS_PIXELS', 'IPictureDisp',
           'OLE_YSIZE_HIMETRIC', 'OLE_TRISTATE', 'IFontDisp',
           'Checked', 'OLE_YSIZE_CONTAINER', 'FONTITALIC',
           'Unchecked', 'FONTSTRIKETHROUGH', 'OLE_CANCELBOOL',
           'Monochrome', 'OLE_XSIZE_HIMETRIC', 'OLE_YPOS_HIMETRIC',
           'OLE_XPOS_HIMETRIC', 'FONTUNDERSCORE',
           'OLE_XPOS_CONTAINER', 'Gray', 'LoadPictureConstants',
           'OLE_COLOR', 'OLE_YPOS_CONTAINER', 'IFont', 'Font',
           'Default', 'OLE_XSIZE_PIXELS', 'IFontEventsDisp',
           'StdFont', 'FontEvents', 'OLE_HANDLE', 'FONTBOLD',
           'OLE_XSIZE_CONTAINER', 'OLE_XPOS_PIXELS', 'FONTSIZE',
           'OLE_OPTEXCLUSIVE', 'IPicture', 'OLE_YSIZE_PIXELS']
